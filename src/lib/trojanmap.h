...
class TrojanMap {
 public:
  ...
  void TraverseDFS(std::string root, std::unordered_map<std::string, std::vector<std::string> > graph, std::map<std::string, bool> &visited, std::vector<std::string> &traversal);
  ...
  std::vector<std::string> opt2swap(std::vector<std::string> &lids, int i, int k);
  ...
  bool hasCycle(std::string cur_id, std::map<std::string, bool> &visited, std::string par_id, std::vector<double> &square);
  ...
  std::vector<std::string> opt3swap(std::vector<std::string> &lids, int i, int j, int k);
